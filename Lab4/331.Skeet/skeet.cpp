...
void Skeet::drawLevel() const
{
   ...
   Draw().drawBackground(time.level() * .1, 0.0, 0.0);
   ...
   // status
   Draw().drawText(Point(10,                         dimensions.getY() - 30), score.getText()  );
   Draw().drawText(Point(dimensions.getX() / 2 - 30, dimensions.getY() - 30), time.getText()   );
   Draw().drawText(Point(dimensions.getX() - 110,    dimensions.getY() - 30), hitRatio.getText());
}
...
void Skeet::drawStatus() const
{
   ...
   if (time.isGameOver())
   {
      ...
      Draw().drawText(Point(dimensions.getX() / 2 - 30, dimensions.getY() / 2 + 10),
               "Game Over");
   ...
   else
   {
      ...
      dr.drawTimer(1.0 - time.percentLeft(),
      ...
      Draw().drawText(Point(dimensions.getX() / 2 - 110, dimensions.getY() / 2 - 10),
         sout.str());
   }
}
